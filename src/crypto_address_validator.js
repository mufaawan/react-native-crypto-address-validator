...
export function getChecksum(hashFunction, payload) {
...
export function getAddressType(address, currency) {
    currency = currency || {};
...
export function validate(address, currencyNameOrSymbol, networkType) {
    ...
    if (currency.symbol == "xlm") {
        return (
            (address.indexOf("G") == 0 || address.indexOf("g") == 0) &&
            address.length == 56
        );
    }
